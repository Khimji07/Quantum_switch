// Publish logs using MQTT on dev server
...
int main(int argc, char *argv[]) {
  ...
  uint8_t sendbuf[30000]; /* sendbuf should be large enough to hold multiple
                            whole mqtt messages */
  uint8_t recvbuf[30000]; /* recvbuf should be large enough any whole mqtt
